...
function ThirteenthStation({ navigation }) {
            ...
            <View style={styles.mainContent}>
              ...
              <View style={styles.mainContentView}>
                ...
                <Text style={styles.defaultText}>
                  ...
                  but secretly, for fear of the Jews, asked pilate that the
                  might take away the body of Jesus, and Pilate gave him leave.
                  So he came and took away his body. Nicodemus also, who had at
                  first come to him by night, came bringing a mixture of myrrh
              ...
              <View style={styles.mainContentView}>
                ...
                <Text style={styles.defaultText}>
                  ...
                  mother’s and not yours those you love will part from you and
                  grief will come to you. You too will die one day-a day you do
                  not know. Are you prepared for it?
                </Text>
              </View>
              ...
              <View style={styles.mainContentView}>
                ...
                <Text style={styles.defaultText}>
                  Lord, help me to accept the partings that must come from
                  friends who go away, and most of all my dear ones when you
                  shall call them to eternal life. Help me to get ready so that
                  the D-Day whenever it comes will not be a shock to me
                </Text>
              </View>
