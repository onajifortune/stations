        ...
        <View style={styles.mainContent}>
          ...
          <View style={styles.mainContentView}>
            ...
            <Text style={styles.defaultText}>
              ...
              took away his body. Nicodemus also, who had at first come to him
              by night, came bringing a mixture of myrrh and aloes, about a
          ...
          <View style={styles.mainContentView}>
            ...
            <Text style={styles.defaultText}>
              Lord, help me to accept the partings that must come from friends
              who go away, and most of all my dear ones when you shall call them
              to eternal life. Help me to get ready so that the D-Day whenever
              it comes will not be a shock to me
            </Text>
          </View>
