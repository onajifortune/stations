        ...
        <View style={styles.mainContent}>
          ...
          <View style={styles.mainContentView}>
            ...
            <Text style={styles.defaultText}>
              ...
              side and Jesus between them. Pilate also wrote a title and put it
          ...
          <View style={styles.mainContentView}>
            ...
            <Text style={styles.defaultText}>
              ...
              bomb of fire in my brain then they seized my other arm. And my
              legs and each time agony again exploded all – for you.
            </Text>
          </View>
          ...
          <View style={styles.mainContentView}>
            ...
            <Text style={styles.defaultText}>
              My God am I worth all this? What can I give you in return? Here
              and now I accept for the rest of my life whatever sickness,
              torment, agony that will come to me you suffered to be my redeemer
              I will suffer to be a co-redeemer of my fellowmen.
            </Text>
          </View>
