          ...
          <ScrollView>
            <View style={styles.mainContent}>
              ...
              <View style={styles.mainContentView}>
                ...
                <Text style={styles.defaultText}>
                  This seventh step, my child, is one that tests your will from
                  this fall learn to persevere in doing good, never say, I can’t
                  go on. Come to me and I will give you rest trust me and carry
                  on.
                </Text>
              </View>
              ...
              <View style={styles.mainContentView}>
                ...
                <Text style={styles.defaultText}>
                  Difficulties remain difficult, Lord! When failure presses
                  heavily on me and I am desolate, discouraged, stretch out your
                  hand to lift me up. Alone, there is nothing I can do. With
                  you, I can do all things, I will.
                </Text>
              </View>
