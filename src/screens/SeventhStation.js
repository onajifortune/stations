      ...
      <View style={styles.mainContent}>
        ...
        <View style={styles.mainContentView}>
          ...
          <Text style={styles.defaultText}>
            ...
            me and I am desolate, discouraged, stretch out your hand to lift me
            up. Alone, there is nothing I can do. With you, I can do all things,
            I will.
          </Text>
        </View>
        ...
        <View style={styles.mainContentView}>
          ...
          <Text style={styles.defaultText}>Till his spirit forth he sent.</Text>
        </View>
      </View>
    </ScrollView>
  );
