        ...
        <View style={styles.mainContent}>
          ...
          <View style={styles.mainContentView}>
            ...
            <Text style={styles.defaultText}>
              ...
              whose it shall be. “This was to fulfil the scripture, “They parted
          ...
          <View style={styles.mainContentView}>
            ...
            <Text style={styles.defaultText}>
              Beholds the poorest king that ever lived before the creatures of
              my own hand I stand stripped the cross – my deathbed is not even
              my own possessing nothing I own all I own my father’s love you too
              own everything so do not worry about your food, your clothes and
              your life.
            </Text>
          </View>
          ...
          <View style={styles.mainContentView}>
            ...
            <Text style={styles.defaultText}>
              ...
              exalt myself, teach me that there is something called humility may
              I be poor in spirit lord.
            </Text>
          </View>
