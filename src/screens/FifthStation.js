...
function FifthStation() {
  return (
    <ScrollView>
      <View style={styles.mainContent}>
        <View style={styles.mainContentCenterContainer}>
          <Text style={styles.h2}>SIMON HELPS JESUS TO CARRY HIS CROSS</Text>
          <Image
        ...
        <View style={styles.mainContentView}>
          ...
          <Text style={styles.defaultText}>
            ...
            compel simon to help me and indeed he helps me why not you too? Lift
            the burden from another back each time you do that, you lift the
            cross’s awful weight that crushes me
          </Text>
        </View>
        ...
        <View style={styles.mainContentView}>
          ...
          <Text style={styles.defaultText}>
            ...
            floor, assist my colleagues in some small task, each time I lend my
            hand in anyway. It maters not to whom my name is Simon, and the
        ...
        <View style={styles.mainContentView}>
          ...
          <View style={styles.mainContentCenterContainer}>
            ...
            <Text style={styles.defaultText}>from partaking in her pain,</Text>
            <Text style={styles.defaultText}>
