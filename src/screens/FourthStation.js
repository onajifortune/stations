      ...
      <View style={styles.mainContent}>
        ...
        <View style={styles.mainContentView}>
          ...
          <Text style={styles.defaultText}>
            ...
            through your own soul that thoughts out of my hearts may be
            revealed”
          </Text>
        </View>
        ...
        <View style={styles.mainContentView}>
          ...
          <Text style={styles.defaultText}>
            ...
            beast. She sees me disgraced. But she did not utter a word of
            protest or complaint. She shares my martyrdom.
          </Text>
        </View>
        ...
        <View style={styles.mainContentView}>
          ...
          <Text style={styles.defaultText}>
            ...
            bear our own pains. To carry my cross after you I too must stand and
            watch the suffering s of my dear ones. I must watch the poverty of
            my people, their tattered clothes, malnutrition, no water, no
            electricity, and what is more, less hope for the future. And, I must
            let them watch time too. I do believe for those who love you, all
            things work together unto good. They must.
          </Text>
        </View>
        ...
        <View style={styles.mainContentView}>
          ...
          <View style={styles.mainContentCenterContainer}>
            ...
            <Text style={styles.defaultText}>whelmed in miseries so deep</Text>
            <Text style={styles.defaultText}>
