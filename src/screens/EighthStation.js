      ...
      <View style={styles.mainContent}>
        ...
        <View style={styles.mainContentView}>
          ...
          <Text style={styles.defaultText}>
            ...
            and for your children. for behold, the days are coming when they
            will say, ‘Blessed are the barren, and the wombs that never bore,
            and the breasts that never gave suck’. Then they will begin to say
            to the mountains, ‘Fall on us’; to the hills cover us’. For if they
        ...
        <View style={styles.mainContentView}>
          ...
          <Text style={styles.defaultText}>
            ...
            with me! but they refused and now these women weep for me. I mourn
            for them and their sorrows that will come. My dear child, you can
            really be more gentle you too can be kind.
          </Text>
        </View>
        ...
        <View style={styles.mainContentView}>
          ...
          <Text style={styles.defaultText}>
            ...
            hurt me with their ridicule those who misunderstand me those whom I
            think hinder my progress with some misguided helpfulness. Those who
            intrude upon my privacy those who restrict my freedom and liberty.
            Then help me curb my tongue may gentleness become my cloak.
          </Text>
        </View>
        ...
        <View style={styles.mainContentView}>
          ...
          <View style={styles.mainContentCenterContainer}>
            ...
            <Text style={styles.defaultText}>touch my spirit from above,</Text>
            <Text style={styles.defaultText}>
