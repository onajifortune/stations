      ...
      <View style={styles.mainContent}>
        ...
        <View style={styles.mainContentView}>
          ...
          <Text style={styles.defaultText}>
            ...
            words, he brought Jesus out and said to the Jews “Here is your
        ...
        <View style={styles.mainContentView}>
          ...
          <Text style={styles.defaultText}>
            ...
            Pilate is unjust but he is the lawful governor and he has power over
            me; and so the son of God obeys a son of man if I will bow to
            Pilate’s rule, because this is my Father’s will can you refuse
            obedience to those whom I have placed over you?
          </Text>
        </View>
        ...
        <View style={styles.mainContentView}>
          ...
          <Text style={styles.defaultText}>
            ...
            will – no more and yet, how hard it is for me to bend remove the
            blinders from my eyes that I may see that it is you whom I obey in
            all who govern me Lord it is you
          </Text>
        </View>
