        ...
        <View style={styles.mainContent}>
          ...
          <View style={styles.mainContentView}>
            ...
            <Text style={styles.defaultText}>
              ...
              sorrows, and acquainted with grief, and as one from whom men hide
          ...
          <View style={styles.mainContentView}>
            ...
            <Text style={styles.defaultText}>
              ...
              court, the hospitals, the jails, wherever suffering exists, my
              face is there and there I look for you to wipe away my blood and
              tears.
            </Text>
          </View>
          ...
          <View style={styles.mainContentView}>
            ...
            <Text style={styles.defaultText}>
              ...
              uncomfortable job but I will not run away from it come and act in
              me and not in me alone – in all men so that we may reveal not your
