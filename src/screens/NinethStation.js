      ...
      <View style={styles.mainContent}>
        ...
        <View style={styles.mainContentView}>
          ...
          <Text style={styles.defaultText}>
            ...
            his grace with the wicked and with a rich man in his death, although
            he had done no violent action and there was no deceit in his mouth.
        ...
        <View style={styles.mainContentView}>
          ...
          <Text style={styles.defaultText}>
            ...
            cannot move and yet my will is mine and so is yours. My child, this
            one thing is certain, your body may be broken but no force on earth
            and none in hell can take away your will, your will is yours.
          </Text>
        </View>
        ...
        <View style={styles.mainContentView}>
          ...
          <Text style={styles.defaultText}>
            ...
            can do the same because my will is mine when all my strength is gone
            and guilt and self-reproach press me to earth and seem to hold me
            fast, when I am pressed down by the consideration that I am of a
            fallen race protect me from the sin of judas save me from despair
            Lord, never let me feel that any sin of mine is greater than your
            love. No matter what my past has been, I can begin anew.
          </Text>
        </View>
