      ...
      <View style={styles.mainContent}>
        ...
        <View style={styles.mainContentView}>
          ...
          <Text style={styles.defaultText}>
            ...
            spices, as is the burial customs of the Jews. Now in the place where
            he was crucified there was a garden, and in the garden a new tomb
            where no one had ever been laid, so because of the Jewish day of
        ...
        <View style={styles.mainContentView}>
          ...
          <Text style={styles.defaultText}>
            ...
            Magdalene for Peter and John for you my work as man is done. My work
            within and through the church must now commence. I look to you. You
            are my friend you are my apostle.
          </Text>
        </View>
        ...
        <View style={styles.mainContentView}>
          ...
          <Text style={styles.defaultText}>
            ...
            have completed your work, what is left is mine, that of my fellowmen
            that of your church. The teachings you could not impart, let me
            impart. The sufferings you could not bear, let me bear. The work of
            love you could not do in you short life on earth. Let me do- all
            through you for you are all in all.
          </Text>
        </View>
