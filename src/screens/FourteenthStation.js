          ...
          <ScrollView>
            <View style={styles.mainContent}>
              ...
              <View style={styles.mainContentView}>
                ...
                <Text style={styles.defaultText}>
                  They took the Body of Jesus, and bound it in lines clothes
                  with the spices, as is the burial customs of the Jews. Now in
                  the place where he was crucified there was a garden, and in
                  the garden a new tomb where no one had ever been laid, so
                  because of the Jewish day of preparation, as the tomb was
              ...
              <View style={styles.mainContentView}>
                ...
                <Text style={styles.defaultText}>
                  So ends my mortal life but now another life begins for Mary
                  and for Magdalene for Peter and John for you my work as man is
                  done. My work within and through the church must now commence.
                  I look to you. You are my friend you are my apostle.
                </Text>
              </View>
              ...
              <View style={styles.mainContentView}>
                ...
                <Text style={styles.defaultText}>
                  Lord Jesus, it is hard to be your apostle the demands are
                  great. You have completed your work, what is left is mine,
                  that of my fellowmen that of your church. The teachings you
                  could not impart, let me impart. The sufferings you could not
                  bear, let me bear. The work of love you could not do in you
                  short life on earth. Let me do- all through you for you are
                  all in all.
                </Text>
              </View>
